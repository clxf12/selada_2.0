package com.example.sispak_kel_9.ml;
...
public final class Sazara {
  @NonNull
  private final Model model;

  private Sazara(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "sazara.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Sazara newInstance(@NonNull Context context) throws IOException {
    return new Sazara(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Sazara newInstance(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    return new Sazara(context, options);
  }
